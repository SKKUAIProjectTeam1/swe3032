...
N_INSTANCES = 200
HIDDEN      = 64
EPOCHS      = 500   # [추가] 과적합 관측을 위해 200 → 500으로 증가
LR          = 1e-3
TRAIN_RATIO = 0.8
SNAPSHOT_TRAIN = '/content/2024_2_snapshot.csv'
SNAPSHOT_VAL   = '/content/2024_2_snapshot.csv'
SNAPSHOT_TEST  = '/content/2025_2_snapshot.csv'
OUT_CSV        = '/content/2025_2_pred.csv'
OUT_PLOT       = '/content/campus_eval_{day}.png'
OUT_LOSS_PLOT  = '/content/loss_curve_{model}.png'  # [추가] 학습 곡선 저장 경로
