"""
multi_campus_gat.py  —  Multi-Campus Dataset GAT Road Designer
...
실행:
  python model/multi_campus_gat.py                      # 학습 → 전체 시각화
  python model/multi_campus_gat.py --load               # 저장 모델 로드 → 전체 시각화
  python model/multi_campus_gat.py --load --infer sungkyunkwan_university
"""
...
# ── 학습 ─────────────────────────────────────────────────────────────────────
def train(campuses: list[dict]) -> MultiCampusRoadGAT:
...
def visualize_all(model: MultiCampusRoadGAT, campuses: list[dict]):
